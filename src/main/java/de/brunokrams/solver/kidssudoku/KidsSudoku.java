...
public class KidsSudoku {
    ...
    private Area[] rows = new Area[ROW_NUMBER];
    private Area[] columns = new Area[COLUMN_NUMBER];

    private Area[][] rectangles = new Area[RECTANGLES_ROW_NUMBER][RECTANGLES_COLUMN_NUMBER];
